/**
 * example from this commit: `https://github.com/emadehsan/thal/commits/36710eadc03bfdd71cced6606170021f31bf6078`
 * uses jsdom
 */
...
async function run() {
  ...
  let LIST_USERNAME_SELECTOR =
    "#user_search_results > div.user-list > div:nth-child(INDEX) > div.d-flex > div > a > em";
  // let LIST_EMAIL_SELECTOR = '#user_search_results > div.user-list > div:nth-child(1) > div.d-flex > div > ul > li:nth-child(2) > a';
  let LIST_EMAIL_SELECTOR =
